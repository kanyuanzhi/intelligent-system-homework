...
p = np.array([[0.06666666666666667, 0.5, 0.26666666666666666, 0.26666666666666666, 0.4666666666666667,
                0.36666666666666664, 0.9666666666666667],
               [0.5, 0.26666666666666666, 0.26666666666666666, 0.4666666666666667, 0.36666666666666664,
                0.9666666666666667, 1.0],
               [0.26666666666666666, 0.26666666666666666, 0.4666666666666667, 0.36666666666666664, 0.9666666666666667,
                1.0, 0.1], [0.26666666666666666, 0.4666666666666667, 0.36666666666666664, 0.9666666666666667, 1.0, 0.1,
                            0.03333333333333333], [0.28, 0.22, 0.58, 0.6, 0.06, 0.02, 0.16],
               [0.22, 0.58, 0.6, 0.06, 0.02, 0.16, 1.0], [0.58, 0.6, 0.06, 0.02, 0.16, 1.0, 0.26],
               [0.6, 0.06, 0.02, 0.16, 1.0, 0.26, 0.14], [0.06, 0.02, 0.16, 1.0, 0.26, 0.14, 0.74],
               [0.02, 0.16, 1.0, 0.26, 0.14, 0.74, 0.8], [0.16, 1.0, 0.26, 0.14, 0.74, 0.8, 0.16]])
t = np.array([[50.0, 13.0, 7.0, 37.0, 40.0, 8.0, 9.0]])
...
w1 = 1 - 2 * rdm3.random_sample((s1, 11))
